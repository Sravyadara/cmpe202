...
public class TaxiDispatch implements DispatchStrategyInterface{
	...
	public Driver searchDriver(Ride ride) throws SQLException {
		...
		//select driver whoose availability status is free and driver type is taxi
		...
		if(driver != null && member_emailId != null){
			...
			if(status != 0){
				...
				System.out.println("Customer-Notification:-----Your ride will reach you at  "+ride.getPickuptime());
